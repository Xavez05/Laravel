<ul class="sidebar-menu">
  ...
  @can('view', new \Spatie\Permission\Models\Permission)
    <li class="{{ setActiveRoute(['productos.index', 'admin.permissions.edit']) }}">
      <a href="{{ route('productos.index') }}">
        <i class="fa-solid fa-cabinet-filing"></i><span>Productos</span>
      </a>
    </li>
  @endcan

  @can('view', new \Spatie\Permission\Models\Permission)
    <li class="{{ setActiveRoute(['clientes.index', 'admin.permissions.edit']) }}">
      <a href="{{ route('clientes.index') }}">
        <i class="fa fa-cabinet-filing"></i><span>Clientes</span>
      </a>
    </li>
  @endcan
</ul>
